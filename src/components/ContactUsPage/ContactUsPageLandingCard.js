    ...
    return (
        <div className="container mx-auto max-w-[1288px] sm:p-10 rounded-lg mt-20 space-y-10">
            <div className="text-center space-y-4 mb-20">
                <h1 className="font-black text-3xl md:text-6xl dark:text-[#EEEEEE]">ارتباط  با <span className="text-[#FF0060]">وبیکسل</span></h1>
                <p className="text-base md:text-xl font-light dark:text-[#EEEEEE]">در این صفحه میتوانید پل های ارتباطی با وبیکسل را مشاهده کنید.</p>
            </div>
            <div className="grid grid-cols-1 place-items-center sm:flex sm:justify-center gap-x-20 gap-y-10">
                <div className="space-y-2 sm:space-y-6">
                    <h2 className="text-lg md:text-xl font-semibold dark:text-[#EEEEEE]">پل های ارتباطی</h2>
                    <ul className="flex gap-x-4">
                        <li className="bg-[#FF0060] text-white hover:bg-[#FFE3E7] hover:text-[#FF0060] rounded duration-200 w-fit p-1 dark:hover:bg-[#0E2338]">
                ...
                <div className="space-y-2 sm:space-y-6">
                    ...
                    <ul className="flex gap-x-4">
                        <li className="bg-[#FF0060] text-white p-1 hover:bg-[#FFE3E7] hover:text-[#FF0060] rounded duration-200 dark:hover:bg-[#0E2338]">
                        ...
                        <li className="bg-[#FF0060] text-white p-1 hover:bg-[#FFE3E7] hover:text-[#FF0060] rounded duration-200 dark:hover:bg-[#0E2338] order-2">
