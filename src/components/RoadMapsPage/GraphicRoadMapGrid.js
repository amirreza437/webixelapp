...
export default function GraphicRoadMapGrid() {
    return (
        <div className="mt-20 space-y-10">
            <div className="flex justify-start items-center gap-x-1 min-[700px]:gap-x-2">
                <h2 className="font-black text-xl min-[700px]:text-3xl text-[#393646]">رود مپ های گرافیک</h2>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 min-[700px]:w-10 min-[700px]:h-10 text-[#334155] -order-last">
