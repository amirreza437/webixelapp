        ...
        <div className="container mx-auto max-w-[1288p]" id="Articles">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7 mt-5">
                <div className="bg-white grid rounded-lg gap-y-4 p-4">
                    ...
                    <h4 className="text-center min-[280px]:text-right font-black text-lg text-[#393646]">اسم مقاله</h4>
