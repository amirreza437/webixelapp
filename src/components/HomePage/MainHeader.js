    ...
    return (
        <div className="bg-white sticky p-12 rounded-b-[240px] z-50 dark:bg-[#0E2338]">
            <div className="container mx-auto max-w-[1288px]">
                <div className="flex justify-between items-center dark:text-[#EEEEEE] lg:grid lg:grid-cols-9">
                    ...
                    <div className="block lg:hidden -order-1">
                        ...
                        <Drawer className="dark:bg-[#0E2338]" open={isOpen} onClose={toggleDrawer} direction='right'>
                            <div className="grid grid-cols-1 gap-y-4 p-5 dark:bg-[#0E2338] dark:text-[#EEEEEE]">
                                <div onClick={toggleDrawer} className="flex justify-between items-center dark:text-[#EEEEEE]">
                                    <svg className="w-7 h-7 order-last fill-current dark:text-[#EEEEEE]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
                                ...
                                <div>
                                    <ul className="flex justify-center gap-x-2 mt-2">
                                        <li className="rounded-full bg-[#ECEEEF] hover:bg-[#FF0060] hover:text-white p-2 flex dark:bg-[#162F48] dark:text-[#EEEEEE]">
                                        ...
                                        <li className="rounded-full bg-[#ECEEEF] hover:bg-[#FF0060] hover:text-white p-2 order-first dark:bg-[#162F48] dark:text-[#EEEEEE]" id="darkMode">
                                ...
                                <div className="my-5">
                                    <form className="relative flex justify-center items-center w-full h-12 rounded-md">
                                        <input className="bg-[#ECEEEF] peer h-full w-full outline-none text-sm text-gray-700 p-4 pr-5 rounded-md dark:bg-[#162F48] dark:text-[#EEEEEE]" type="search" placeholder="دنبال چیزی هستی؟" />
                                    </form>
                                </div>
                                <div>
                                    <ul className="flex flex-col justify-center gap-y-5 text-[#393646]">
                                        <li className="hover:text-[#FF0060] font-medium">
                                            <Link href="/" className="flex justify-between items-center dark:text-[#EEEEEE]">صفحه اصلی
                                        ...
                                        <li className="hover:text-[#FF0060] font-medium">
                                            <Link href="/articles" className="flex justify-between items-center dark:text-[#EEEEEE]">مقالات
                                                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        ...
                                        <li className="hover:text-[#FF0060] font-medium">
                                            <Link href="/roadmaps" className="flex justify-between items-center dark:text-[#EEEEEE]">رود مپ ها
                                                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        ...
                                        <li className="hover:text-[#FF0060] font-medium">
                                            <Link href="/about-us" className="flex justify-between items-center dark:text-[#EEEEEE]">درباره ما
                                                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        ...
                                        <li className="hover:text-[#FF0060] font-medium">
                                            <Link href="/contact-us" className="flex justify-between items-center dark:text-[#EEEEEE]">تماس با ما
                                                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
