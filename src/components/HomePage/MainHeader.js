    ...
    return (
        <div className="bg-white sticky p-12 rounded-b-[240px] z-50">
                                ...
                                <div>
                                    <ul className="flex flex-col justify-center gap-y-5 text-[#393646]">
                                        <li className="hover:text-[#FF0060] font-medium">
                                            <a href="#" className="flex justify-between items-center">صفحه اصلی
                                        ...
                                        <li className="hover:text-[#FF0060] font-medium">
                                            <a href="#" className="flex justify-between items-center">مقالات
                                                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        ...
                                        <li className="hover:text-[#FF0060] font-medium">
                                            <a href="#" className="flex justify-between items-center">رود مپ ها
                                                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        ...
                                        <li className="hover:text-[#FF0060] font-medium">
                                            <a href="#" className="flex justify-between items-center">پادکست ها
                                                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                        ...
                                        <li className="hover:text-[#FF0060] font-medium">
                                            <a href="#" className="flex justify-between items-center">درباره ما
                                                <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <ul className="hidden lg:flex justify-center gap-x-5 text-[#393646] mt-4 translate-y-4">
                <li className="hover:text-[#FF0060] font-medium"><a href="#">صفحه اصلی</a></li>
                <li className="hover:text-[#FF0060] font-medium"><a href="#">مقالات</a></li>
                <li className="hover:text-[#FF0060] font-medium"><a href="#">رود مپ ها</a></li>
                <li className="hover:text-[#FF0060] font-medium"><a href="#">پادکست ها</a></li>
                <li className="hover:text-[#FF0060] font-medium"><a href="#">درباره ما</a></li>
            </ul>
        </div>
    )
}