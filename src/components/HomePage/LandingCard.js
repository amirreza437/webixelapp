        ...
        <div className="container mx-auto max-w-[1288px] p-10 rounded-[100px] mt-10 text-center">
            <div className="grid grid-cols-1 gap-y-6">
                <div className="flex justify-center">
                    <h1 className="font-black text-[#393646] text-2xl md:text-3xl lg:max-[1075px]:text-4xl lg:max-[1304px]:text-5xl xl:text-6xl md:leading-relaxed">
                        <span className="text-[#FF0060] order-last">وبیکسل،</span>
                         مجله آموزشی برنامه نویسی و گرافیک
                    </h1>
                </div>
                <p className="text-xl text-[#393646] hidden lg:block">ماهی رو هر وقت از آب بگیری تازست !</p>
                <div className="flex justify-center">
                    <button className="bg-[#FF0060] text-white rounded p-4 grid grid-cols-1 place-items-center sm:flex items-center gap-y-2 sm:gap-x-2 hover:bg-[#393646] duration-300">چجوری شروع کنم؟
