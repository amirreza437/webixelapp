...
export default function CrashingCards() {
    return (
        <div className="container mx-auto max-w-[1288px] p-10 mt-10 grid gap-y-4">
            <div className="bg-[#ECEEF0] flex justify-center md:justify-between items-center rounded-t-3xl md:px-10 py-3 md:py-12 dark:bg-[#0E2338]">
            ...
            <div className="bg-[#ECEEF0] flex justify-center md:justify-between gap-x-12 items-center rounded-b-3xl md:px-10 py-3 md:py-12 dark:bg-[#0E2338]">
