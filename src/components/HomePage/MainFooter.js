...
export default function MainFooter() {
    return (
        <div className="sticky top-[100vh] bg-[#32527C] bg-opacity-10">
            <div className="container mx-auto max-w-[1288px] p-10 grid grid-cols-1 place-items-center gap-y-5 md:flex md:justify-between items-center">
            ...
            <div className="container mx-auto max-w-[1288px] p-10 grid grid-cols-1 lg:grid-cols-6 gap-x-5 gap-y-10 text-center lg:text-right items-start -translate-y-14 md:-translate-y-7">
            ...
            <div className="container mx-auto max-w-[1288px] text-center grid gap-y-2">
                <hr className="border-2 border-t-gray-300"/>
                <p className="text-xs font-extralight mb-4">کلیه محصولات و مطالب این سایت متعلق به وبیکسل است و هر گونه کپی برداری از محتوای سایت غیر مجاز بوده و بدون رضایت ماست.</p>
            </div>            
        </div>
    )
}