    ...
    return (
        <>
            ...
            pagination={{ clickable: true }}>
                        <SwiperSlide className="bg-white grid rounded-lg gap-y-4 p-4 dark:bg-[#0E2338]">
                            <div className="relative pt-32">
                                ...
                                <div className="grid grid-cols-1 gap-y-2">
                                    ...
                                    <Link href='/courses/[courseId]?courseId=1' className="text-center min-[280px]:text-right font-black text-lg text-[#393646] dark:text-[#EEEEEE]">اسم دوره</Link>
                        ...
                        <SwiperSlide className="bg-white grid rounded-lg gap-y-4 p-4 dark:bg-[#0E2338]">
                            <div className="relative pt-32">
                                <div className="absolute w-full -top-12">
                                    <Link href='/courses/[courseId]?courseId=1' className="inline-block h-40 overflow-hidden w-full rounded-lg">
                                        <Image className="w-full h-full object-cover transform transition duration-200 hover:scale-110" src={a} />
                                    </Link>
                                </div>
                                <div className="grid grid-cols-1 gap-y-2">
